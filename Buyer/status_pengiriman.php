...
// Dummy data pengiriman produksi
$produksi = [
    [
        'nama_produk' => 'Kaos Polo Abu',
        'status' => 'Dikirim',
        'tanggal_kirim' => '2025-07-10',
        'estimasi_sampai' => '2025-07-14'
    ]
];
...
<div class="container">
  ...
  <div class="main-content">
    <h2>Status Pengiriman Produksi</h2>

    <?php foreach ($produksi as $p): ?>
      <?php $step = getStatusStep($p['status']); ?>
      <div class="tracking-box">
        <div class="product-title"><?= htmlspecialchars($p['nama_produk']) ?></div>
        <div class="info-dates">
          Tanggal Dikirim: <?= htmlspecialchars($p['tanggal_kirim']) ?><br>
          Estimasi Sampai: <?= htmlspecialchars($p['estimasi_sampai']) ?>
        </div>
