...
<div class="container">
  ...
  <div class="main-content">
    ...
    <div class="invoice-buttons">
      <button onclick="navigate('produksi_lanjutan.php')">Form Pengajuan Produksi Lanjutan</button>
      <button onclick="navigate('status_pengiriman.php')">Status Pengiriman Produksi</button>
      <button onclick="navigate('feedback_produksi.php')">Feedback Produksi</button>
      <button onclick="navigate('daftar_pesanan.php')">Daftar Pesanan</button>
      <button onclick="navigate('unduh_invoice.php')">Unduh Invoice</button>
    </div>
  </div>
</div>
