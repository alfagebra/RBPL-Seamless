...
<div class="container">
  <div class="sidebar">
    ...
    <div class="menu">
      ...
      <div class="menu-item active" onclick="navigate('internalComm.php')">Internal Communication</div>
  ...
  <div class="main-content">
    ...
    <div class="contact-buttons">
      ...
      <button class="<?= $receiver === 'garment' ? 'active' : '' ?>" onclick="selectContact('garment')">Garment</button>
    </div>
