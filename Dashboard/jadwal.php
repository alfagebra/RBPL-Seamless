...
<head>
  ...
  <title>Active Production Schedule</title>
  ...
  <div class="container">
    <div class="sidebar">
      ...
      <div class="menu">
        ...
        <div class="menu-item active" onclick="navigate('jadwal.php')">Active Production Schedule</div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>2025-07-08</td>
            <td>2025-07-18</td>
            <td class="status-proses">Sedang Proses</td>
          </tr>
          <tr>
            <td>ORD003</td>
            <td>PT Mode Raya</td>
            ...
            <td>2025-07-12</td>
            <td>2025-07-25</td>
            <td class="status-belum">Belum Dimulai</td>
          </tr>
        </tbody>
      </table>
    </div>
